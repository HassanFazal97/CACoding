...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createClearUsersUseCase(viewManagerModel, clearViewModel, userDataAccessObject );
    ...
    private static ClearController createClearUsersUseCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException{
